...
public class ATM {
    ...
    private static ArrayList<Notes> notesList=new ArrayList<>(Arrays.asList(new TwoThousand("2000",0),new FiveHundred("500",0),new TwoHundred("200",0),new Hundred("100",0)));   // Craeted a noteslist with a assigned list
